...
# Delay importing extractor modules until actually needed to avoid importing
# non-existent extractors at test collection time.
class _LazyImporter:
    ...
    def _load(self):
        if self._obj is None:
            module = __import__(self._module, fromlist=[self._name])
...
YoutubeIE = _LazyImporter("yt_dlp.extractor", "YoutubeIE")
InfoExtractor = _LazyImporter("yt_dlp.extractor.common", "InfoExtractor")
