...
if not _LAZY_LOADER:
    try:
        ...
        # If the generated extractors module is missing (e.g. some extractor
        # modules not present in the environment), avoid hard failure and
        # fall back to an empty class list. Lazy loaders may populate this
